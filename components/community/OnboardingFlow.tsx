    ...
    <form onSubmit={submit} style={{ display: 'grid', gap: 18 }}>
      ...
      <div style={{ background: '#fbf7ef', border: '1px solid rgba(201,154,91,.22)', borderRadius: 16, padding: '18px 18px' }}>
        ...
        <label style={{ display: 'flex', gap: 10, alignItems: 'flex-start', fontSize: 14.5, color: 'var(--ink)', lineHeight: 1.6, cursor: 'pointer' }}>
          ...
          />
          <span>
            <strong>אני מסכים/ה לתקנון ולמדיניות הפרטיות.</strong> אני מבין/ה ש: (1) השם, פרטי הכלב, תיאומי ההגעה והודעות בצ'אט גלויים לחברים בקהילה הסגורה. (2) המידע מאוחסן ב-Supabase (שרתים בארה"ב) ומיילים נשלחים דרך Resend. (3) תיאומים נחשפים רק 15 דקות לפני שעת ההגעה, והודעות נמחקות אוטומטית אחרי 24 שעות. (4) המידע נאסף לתפעול הקהילה בלבד ולא יימסר לצד שלישי לשיווק. (5) ניתן למחוק את החשבון ולקבל את המידע בכל עת.{' '}

...
/* הערה: הקבוצה בהתהוות. אין בקופי הזה שום טענה על מספר חברים או על זמני
   תגובה - רק הזמנה כנה להיות מהראשונים. אין להוסיף מספרים שלא נבדקו. */
const COPY: Record<Tone, { title: string; sub: string; cta: string }> = {
  walks: {
    title: 'הייתם במסלול הזה? ספרו בקבוצה',
    sub: 'בקבוצת הפייסבוק שלנו בעלי כלבים משתפים מסלולים שעובדים, אזהרות (פחים, חתולים, יתושים) וטיפים שאי אפשר למצוא בשום אתר. הקבוצה בתחילת הדרך, וכל מי שמצטרף עכשיו מעצב אותה.',
    cta: 'הצטרפו לקבוצה לפני הטיול הבא 🐾',
  },
  parks: {
    title: 'איזו גינה הכי שווה אצלכם?',
    sub: 'בקבוצת הפייסבוק שלנו משתפים איפה יש חבר\'ה עכשיו, איזו גינה מוצלת בקיץ ואיפה הכלב באמת בטוח. אנחנו רק בהתחלה - בואו לספר על הגינה שלכם.',
    cta: 'בואו לקבוצה לקבל המלצות מקומיות 🐕',
  },
  guides: {
    title: 'יש לכם שאלה? שאלו בקהילה',
    sub: 'בקבוצת הפייסבוק שלנו שואלים בעלי כלבים אחרים - מאילוף ועד וטרינרים מומלצים בעיר שלכם. הקבוצה צעירה וגדלה, וכל שאלה טובה עוזרת לה לצמוח.',
    cta: 'הצטרפו לקהילה בפייסבוק 💬',
  },
  general: {
    title: 'הקהילה שלנו בפייסבוק',
    sub: 'קבוצה חדשה של בעלי כלבים מכל הארץ - שואלים, ממליצים, מזהירים ומחפשים חברה לטיול. אנחנו בתחילת הדרך, אז כל מי שמצטרף עכשיו הוא מהראשונים שבונים אותה.',
    cta: 'הצטרפו עכשיו 🐾',
  },
}

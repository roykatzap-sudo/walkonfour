  ...
  if (state === 'done' || state === 'dup') {
    return (
      <div style={{ background: 'linear-gradient(135deg, #fffaf0, #fdf6e9)', border: '2px solid var(--brand)', borderRadius: 18, padding: '24px 22px', textAlign: 'center' }}>
        ...
        <div style={{ marginTop: 18, paddingTop: 16, borderTop: '1px solid rgba(201,154,91,.25)' }}>
          <p style={{ fontSize: 14.5, color: 'var(--ink)', margin: '0 0 10px', lineHeight: 1.6 }}>
            רוצים כבר עכשיו? הקהילה חיה בפייסבוק - שאלות, טיפים והמלצות מבעלי כלבים מכל הארץ.
          </p>
          <a
            href="https://www.facebook.com/groups/2421586375002894"
            target="_blank"
            rel="noopener noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#1877f2', color: '#fff', fontWeight: 800, fontSize: 15, padding: '11px 22px', borderRadius: 999, textDecoration: 'none' }}
          >
            <svg viewBox="0 0 24 24" width="18" height="18" fill="#fff" aria-hidden="true"><path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5 3.66 9.15 8.44 9.94v-7.03H7.9v-2.9h2.54V9.85c0-2.51 1.49-3.9 3.78-3.9 1.1 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.44 2.9h-2.34V22c4.78-.79 8.44-4.94 8.44-9.94Z"/></svg>

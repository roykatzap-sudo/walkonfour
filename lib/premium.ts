...
export const PLANS: Plan[] = [
  {
    ...
    cta: 'התחילו בחינם',
    toast: 'מצוין! הצטרפתם לקהילה על ארבע בחינם - בואו נבנה לכלב פרופיל 🐾',
  },
  {
    id: 'premium',
    name: 'פרימיום',
  ...
  },
  {
    id: 'business',
    name: 'עסקים',
    tagline: 'הגיעו לבעלי כלבים שמחפשים בדיוק אתכם',
    price: 149,
    unit: 'לעסק / חודש',
    ...
    features: [
      ...
      { label: 'ליווי אישי מצוות קהילה על ארבע', included: true },
    ],
    cta: 'הצטרפו כעסק',
    toast: 'תודה! צוות קהילה על ארבע יחזור אליכם עם פרטי ההצטרפות לספרייה 🐾',
  },
]
...
/** דרך הכנסה שקופה - לסקשן "איך קהילה על ארבע מתפרנסת". */
...
/** מנועי ההכנסה של קהילה על ארבע - שקיפות מלאה. */
export const REVENUE_STREAMS: RevenueStream[] = [
  ...
  },
  {
    ...
    body:
      'דמי החבר החודשיים מממנים את הצוות, את השרתים ואת הפיתוח - בלי פרסומות שמרדפות אתכם ובלי מכירת נתונים. המנוי הוא מה שמחזיק את קהילה על ארבע עצמאית ונאמנה רק לכם.',
  },
]

    ...
    <main className="page" style={{ maxWidth: 860 }}>
      ...
      <article style={{ marginTop: 32 }}>
        {s.sections.map((sec, i) => (
          <section key={i} className="kv-reveal" style={{ marginBottom: 32 }}>
      ...
      {/* מפריד כף-רגל ממותג לפני השאלות הנפוצות */}
      <div className="kv-paw-divider" aria-hidden="true" style={{ marginTop: 20 }} />

      {/* FAQ */}
      <section className="kv-reveal" style={{ marginTop: 16 }}>

...
const TOOLS: Tool[] = [
  {
    ...
    desc: 'שמונה שאלות על הבית, הילדים, הזמן והקיץ שלכם, ובסוף שלושה גזעים שלא תתחרטו עליהם. בלי "כל כלב מקסים בדרכו" - אנחנו אומרים מה אנחנו חושבים.',
    tag: 'שמונה שאלות, שלוש תשובות',
    d: 1,
  },
  {
    href: '/names',

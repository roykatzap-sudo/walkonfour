...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    icon: '❤️',
    title: 'מה ששמרתם',
    desc: 'שמות, גזעים, מדריכים ומסלולים שסימנתם לעצמכם ברחבי כלבניה. חוזרים אליהם בלי לחפש שוב מה זה היה שאהבתם לפני שבועיים.',
    tag: 'האוסף שלכם',
    d: 3,
  },
  {
      ...
      <Reveal3D>
        ...
        >
          ...
          <p style={{ margin: '0 auto 22px', maxWidth: 560, lineHeight: 1.8, opacity: 0.92 }}>
            מאחורי הכלים יש אנשים. קבוצת רכישה שמורידה שק רויאל קנין מ-290 ל-198,
